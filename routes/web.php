...
Route::group(['prefix'=>'admin','middleware'=>['web','auth']],function (){
    ...
    Route::get('/update/post/{id}',['uses'=>'Admin\AdminPostController@show', 'as'=>'admin_add_post']);
    Route::post('/update/post',['uses'=>'Admin\AdminPostController@create', 'as'=>'admin_update_post']);
});